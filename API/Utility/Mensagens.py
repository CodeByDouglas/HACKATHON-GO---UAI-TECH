...
Que bom que você quer discartar seus resíduos
de forma ecologica e sustentável, escolha uma das
opções de descarte a baixo. 
1 - Descartar em um ecoponto.
2 - Instituições parceiras.
3 - Progamas da Prefeitura. """

Menu_denuncia = """
Em qual dos tópicos se equadra a sua denúncia: 
...
Me envie sua denúncia em formato de texto
Coso, tenha fotos ou vídeos do ocorrido, pode
me encaminhar também. 
"""
